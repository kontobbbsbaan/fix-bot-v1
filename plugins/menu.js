 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	title: `𝙇𝙄𝙎𝙏 𝙈𝙀𝙉𝙐 `,
	rows: [
	    {title: `𝗧𝗘𝗦𝗧𝗜𝗡𝗚 𝗦𝗣𝗘𝗘𝗗`, rowId: ".speed", description: "Menampilkan kecepatan respon BOT"},
	    {title: `𝗢𝗪𝗡𝗘𝗥 𝗕𝗢𝗧`, rowId: ".owner", description: "Menampilkan List owner BOT"},
	    {title: `𝗦𝗖𝗥𝗜𝗣𝗧 𝗕𝗢𝗧`, rowId: ".sc", description: `Source Code ${namebot}`},
	    {title: `𝗦𝗘𝗪𝗔 𝗕𝗢𝗧`, rowId: ".sewa", description: "Menampilkan list harga sewa BOT"},
	    {title: `𝗕𝗨𝗬 𝗣𝗥𝗘𝗠𝗜𝗨𝗠`, rowId: ".premium", description: "Menampilkan list harga premium"},
	    {title: `𝗗𝗢𝗡𝗔𝗦𝗜`, rowId: ".donasi", description: 'Support BOT agar lebih fast respon'},
	    {title: `𝗔𝗟𝗟 𝗠𝗘𝗡𝗨`, rowId: ".? all", description: "Menampilkan Semua command BOT"},
	    {title: `𝗚𝗔𝗠𝗘 𝗥𝗣𝗚`, rowId: ".? rpg", description: "Game Epic Rpg!"},
	{title: `𝗘𝗫𝗣`, rowId: ".? xp", description: "Ayo tingkatkan pangkat mu!"},
	{title: `𝗚𝗔𝗠𝗘`, rowId: ".? game", description: "Gamenya seru seru lho >-<"},
	{title: `𝗙𝗨𝗡`, rowId: ".? fun", description: "Fitur yang aman untuk keluarga"},
	{title: `𝗞𝗘𝗥𝗔𝗡𝗚`, rowId: ".? kerangajaib", description: "Tanyakan pada ketua club"},
	{title: `𝗤𝗨𝗢𝗧𝗘𝗦`, rowId: ".? quotes", description: "Random Inspirasi"},
	{title: `𝗔𝗡𝗜𝗠𝗘`, rowId: ".? anime", description: "Kamu wibu ya bang?"},
	{title: `𝗡𝗦𝗙𝗪`, rowId: ".? nsfw", description: "Tch, dasar sagne"},
	{title: `𝗣𝗥𝗘𝗠𝗜𝗨𝗠`, rowId: ".? premium", description: "Only premium Users"},
	{title: `𝗔𝗡𝗢𝗡𝗬𝗠𝗢𝗨𝗦 𝗖𝗛𝗔𝗧`, rowId: ".? anonymous", description: "Bicara dengan orang tidak dikenal"},
